...
std::vector<std::string> cLight::getAllDataStrings() {
	...
	result.push_back(std::to_string(this->_ColourR));
	result.push_back(std::to_string(this->_ColourG));
	result.push_back(std::to_string(this->_ColourB));
...
sNVPair cLight::RecieveMessage(sNVPair message)
{
	...
	{
		this->_PositionX -= message.fValue;
		response.name = "OK";
		return response;
	}
	...
	{
		this->_PositionY -= message.fValue;
		response.name = "OK";
		return response;
	}
	...
	{
		this->_PositionZ -= message.fValue;
		response.name = "OK";
		return response;
	}
